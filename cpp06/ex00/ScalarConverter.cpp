...
/*   ScalarConverter.cpp                                :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: ogrativ <ogrativ@student.42.fr>            +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/07/21 11:46:12 by ogrativ           #+#    #+#             */
/*   Updated: 2025/10/27 12:32:05 by ogrativ          ###   ########.fr       */
/*                                                                            */
/******************************************************************************/
...
static bool isInt(const std::string &s) {
    ...
    return *end == '\0' && errno == 0 && value >= std::numeric_limits<int>::min() &&
...
static bool isFloat(const std::string &s) {
    ...
    return (end && *end == 'f' && *(end + 1) == '\0' && errno == 0);
}
...
int ScalarConverter::toInt(char val) { return static_cast<int>(val); }
...
float ScalarConverter::toFloat(int val) { return static_cast<float>(val); }
...
double ScalarConverter::toDouble(int val) { return static_cast<double>(val); }

double ScalarConverter::toDouble(float val) { return static_cast<double>(val); }
